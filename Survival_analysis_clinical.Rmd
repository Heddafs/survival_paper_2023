...
table_descriptive <- tableby(~Age + Neuter_status + Grade + ER_status + Lymphatic_invasion + Breed + HER2_score + subtype_MPAM50, data = clinical_tbl) 
...
ggplot(clinical_tbl, aes(x=Status_survival))+
  ...
  coord_flip()+
  theme_bw()+
  ggtitle("Breed group alternative 1")
```
...
ggplot(clinical_tbl, aes(x=Status_survival))+
  ...
  coord_flip()+
  theme_bw()+
  ggtitle("Breed group alternative 2")
```

Distribution of censored and non-censored dogs in small and larger
breeds
