...
ggsave(file = "plots/KMplot_ER.png", plot= print(ER.plot$plot), height = 3.5, width = 5)
ggsave(file = "plots/KMplot_MPAM.png", plot= print(MPAM.plot$plot), height = 3.5, width = 5)
ggsave(file = "plots/KMplot_lymph.png", plot= print(Lymph_inv.plot$plot), height = 3.5, width = 5)
ggsave(file = "plots/KMplot_grade.png", plot= print(Grade.1.plot$plot), height = 3.5, width = 5)
ggsave(file = "plots/KMplot_age.png", plot= print(Age.plot$plot), height = 3.5, width = 5)
...
tab_model(data = fit.best.both, title = "Multivariate cox model", string.est = "Hazard")
```
...
```{r}
variables_both <- clinical_onehot %>% mutate_if(is.factor, as.numeric) %>% select(-Survival_days, -Status_survival, -is_Malignant)
...
colnames(corr_matrix) <- c("Age", "Lymphatic invasion", "Carcinoma", "ER positive", "Neutered", "MPAM50 basal-like subtype", "Maltese", "Grade1", "Grade2", "Grade3", "HER2 score 1", "HER2 score 2", "HER2 score 3")
rownames(corr_matrix) <- c("Age", "Lymphatic invasion", "Carcinoma", "ER positive", "Neutered", "MPAM50 basal-like subtype", "Maltese", "Grade1", "Grade2", "Grade3", "HER2 score 1", "HER2 score 2", "HER2 score 3")

corrplot::corrplot(corr_matrix, order = "original", tl.col = 'black', tl.cex = 0.6, tl.srt = 45, type = "lower", diag = F)
